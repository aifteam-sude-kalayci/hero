...
export default function ServiceDetail() {
  ...
  // Canvas animation effect for hero section
  useEffect(() => {
    if (!heroCanvasRef.current || !heroSectionRef.current) return;
  ...
  return (
    <div className="service-detail-page" ref={detailRef}>
        {/* Hero Section */}
        <section className="service-hero" ref={heroSectionRef}>
            <canvas ref={heroCanvasRef} className="hero-canvas"></canvas>
